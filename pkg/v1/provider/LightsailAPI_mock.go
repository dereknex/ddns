...
func (_m *LightsailAPI) GetDomain(input *lightsail.GetDomainInput) (*lightsail.GetDomainOutput, error) {
	domainName, name, value, typ := "example.com", "test", "10.0.0.1", "A"
	...
	output := &lightsail.GetDomainOutput{
		Domain: &lightsail.Domain{
			Name:          &domainName,
			DomainEntries: []*lightsail.DomainEntry{entry},
		},
	}
	if *input.DomainName == domainName {
		return output, nil
	}
